"""
Taken from https://github.com/cdfuller/echo-server

Used to test whether the proxy settings work
"""
...
def serve(host='127.0.0.1', port=8080, verbosity=1):
    try:
...
def main():
    ...
    parser.add_argument('-b', '--bind', default='127.0.0.1', help='host to bind to')
